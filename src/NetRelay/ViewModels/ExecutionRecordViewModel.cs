...
public sealed class ExecutionRecordViewModel
{
    ...
    public string ReasonLabel
    {
        get
        {
            ...
            return Record.WindowsErrorCode.HasValue
                ? $"{baseMessage}（Windows 错误 {Record.WindowsErrorCode.Value}）"
                : baseMessage;
        }
    }
    ...
    public string SourceLabel => Record.Source switch
    {
        ...
        RuleSource.NetworkChange => "联网探测触发",
