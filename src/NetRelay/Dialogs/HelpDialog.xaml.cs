...
public partial class HelpDialog : Window
{
    ...
    private static IReadOnlyList<HelpTopic> BuildTopics()
    {
        ...
        [
            new HelpTopic(
                "快速开始",
                "先确认 NetRelay 能做什么，再决定使用手动控制还是自动化规则。",
                [
                    new HelpSection(
                        "NetRelay 是做什么的",
                        "NetRelay 当前围绕本机网卡的启用、禁用、提醒、恢复和诊断展开。",
                        [
                            "它可以手动启用或禁用指定网卡。",
                            "它可以按规则在指定时间或指定网络状态下启用、禁用目标网卡。",
                            "它会在关键操作前做保护检查，尽量避免误操作导致整机断网。",
                            "它不是网络代理、加速器，也不是多网卡自动选路工具。"
                        ]),
                    new HelpSection(
                        "最短使用路径",
                        null,
                        [
                            "首次运行先勾选同意并完成设备激活。",
                            "进入“网络概览”确认网卡状态，再手动启用或禁用目标网卡。",
                            "需要自动执行时，进入“自动化规则”新建规则；建议先从定时规则开始测试。",
                            "结果不符合预期时，先看“执行历史”，再按需要导出诊断包提交反馈。"
                        ])
                ]),
            new HelpTopic(
                "网络概览与手动控制",
                ...
                [
                    new HelpSection(
                        ...
                        [
                            ...
                            "开启“手动禁用保护”后，手动禁用网卡前会先验证是否还有其他网卡可访问互联网，避免直接导致整机断网。"
                        ]),
                    new HelpSection(
                        "手动禁用保护是什么",
                        null,
                ...
                [
                    new HelpSection(
                        ...
                        [
                            ...
                            "如果当前已经是最新版本，启动时不会弹窗打扰；手动检查时会显示最新状态。"
                        ]),
                    new HelpSection(
                        "更新历史显示什么",
                        null,
                    ...
                    new HelpSection(
                        ...
                        [
                            ...
                            "如果更新失败，优先重试一次；仍失败时可导出诊断包提交反馈。"
                        ]),
                    new HelpSection(
                        "关于备用源",
                        null,
                        [
                            "主更新源暂时不可用时，程序会尝试备用源检查和下载更新。",
                            "备用源只用于提高更新可用性。用户不需要手动配置，也不需要关心它位于哪里。"
                        ])
                ]),
            new HelpTopic(
                "反馈、日志与诊断包",
                "遇到问题时，可以通过反馈和诊断包提供足够线索。",
                [
                    new HelpSection(
                        "建议与反馈页面",
                        null,
                    ...
                    new HelpSection(
                        ...
                        [
                            ...
                            "诊断包会尽量帮助定位问题，同时避免包含个人文件、用户名、原始硬件序列号等隐私内容。"
                        ]),
                    new HelpSection(
                        "什么时候该导出诊断包",
                        null,
            ...
            new HelpTopic(
                ...
                [
                    ...
                    new HelpSection(
                        ...
                        null,
                        [
                            "启用开机自启动后，登录 Windows 时程序会静默进入托盘，不显示主窗口；需要操作时再从托盘打开。",
                            "打开主窗口。",
                            "检查更新。",
                            "导出诊断包、打开日志目录、打开更新缓存。",
                            "直接退出程序。"
            ...
            new HelpTopic(
                "受限模式、隐私与设备激活",
                "这里解释首次同意、设备激活和受限状态对普通使用的影响。",
                [
                    new HelpSection(
                        "受限模式是什么",
                        null,
                        [
                            "当设备状态不允许继续执行网卡控制时，客户端会进入受限模式。",
                    ...
                    new HelpSection(
                        ...
                        [
                            ...
                            "激活使用的是脱敏后的设备标识，不上传原始硬件序列号，也不读取个人文件、用户名或周边 Wi‑Fi 等隐私内容。"
                        ]),
                    new HelpSection(
                        "需要避免的误区",
                        null,
