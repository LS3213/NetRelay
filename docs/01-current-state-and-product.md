...
项目根目录在文档创建前完全为空。当前已经初始化 Git 仓库，并完成第一阶段桌面应用骨架。
...
以下内容仍无当前实现，后文只描述计划设计：

- 网卡启用/禁用、后台任务、规则 API、事件或外部服务集成。
- 数据模型、数据库、缓存、队列、文件存储或迁移。
- 账号、鉴权、权限控制、会话或密钥管理。
- 日志、监控、错误处理、构建、测试、部署或升级流程。
