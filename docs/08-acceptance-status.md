...
截至 2026-06-14，NetRelay 客户端及后端平台 B0-B5 阶段（包括双源更新、反馈、日志上传、公告与封锁受限模式）的代码实现与验收已全部完成，自动化质量门槛已全部通过。Windows Toast 真实点击、物理网卡切换、休眠、重新登录和跨 Windows 版本行为尚未手动实机验收，不得视为全部通过。
